classdef ImageRegistrator < phm.core.phmCore
    ...
    methods
        function obj = ImageRegistrator(configs)
        ...
        function [result, frames] = preprocess (obj, frames)
            ...
            obj.StitchedFrame = zeros(result.stitchedSize, 'like', frames{1}.Frame);
            obj.StitchedMask = zeros(result.stitchedSize, 'like', frames{1}.Frame);
        end
